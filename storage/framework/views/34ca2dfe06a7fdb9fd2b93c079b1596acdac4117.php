...
<html lang="<?php echo e(str_replace('_', '-', app()->getLocale())); ?>">
    ...
    <footer style="background: rgb(163, 1, 50)">
        <div style="text-align: center; color: white;">
            <?php
                echo config('iexpert.app_copyright') . " &reg; 2021";
            ?>
        </div>
    </footer>
</html>
<?php /**PATH C:\laragon\www\i-expert\resources\views/welcome.blade.php ENDPATH**/ ?>