                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-12">
                            <form class="m-t" role="form" action="/verify-forgot-password" method="POST">
                                ...
                                <button type="submit" class="btn btn-primary block full-width m-b">Hantar katalaluan baru</button>
...
<?php /**PATH C:\laragon\www\i-expert\resources\views/authentication/reset_password.blade.php ENDPATH**/ ?>